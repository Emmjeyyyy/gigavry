...
export const Pagination: React.FC<PaginationProps> = ({ currentPage, totalPages, onPageChange }) => {
  ...
  return (
    <nav aria-label="Pagination" className="mt-12 mb-0 px-4 w-full flex justify-center">
      <div className="inline-flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 bg-givry border-2 border-cocoa/20 rounded-2xl p-3 sm:px-6 sm:py-3">
